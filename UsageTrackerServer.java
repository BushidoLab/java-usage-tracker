...
public class UsageTrackerServer {
    ...
    private void recordLog(String data) throws Exception {
        ...
        String payload = "{\"channel\": \"default\",\"chaincode\":\"usage-tracker-10\",\"chaincodeVer\":\"1.0\",\"method\":\"initLog\",\"args\":[\""+tokens[0]+"\",\""+tokens[1]+"\", \""+tokens[2]+"\",\""+tokens[5]+"\", \""+tokens[6]+"\", \""+tokens[8]+"\", \""+tokens[9]+"\", \""+tokens[10]+"\"]}";
        StringEntity params = new StringEntity(payload,ContentType.APPLICATION_JSON);

        static void main(String[] args) throws MalformedURLException, ProtocolException, IOException {
            ...
            try {
                ...
                try (BufferedRea(der in = new BufferedReader(new InputStreamReader(con.getInputStream)))) {
                    String line;
        ...
        // Add request header
        // con.setRequestMethod("POST");
        // String urlParameters = "bcsgw/rest/v1/transaction/invocation";
